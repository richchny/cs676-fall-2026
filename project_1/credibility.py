...
TLD_SCORES: Dict[str, float] = {
    ...
    ".info": 0.30,
    ".xyz": 0.25,
    ".int": 0.80 #The .int top-level domain is a specialized internet extension strictly reserved for organizations established by international treaties between national governments.
}
